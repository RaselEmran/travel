...
@section('content')
     <div class="panel panel-flat">
              <div class="panel-heading">
                    <h5 class="panel-title">News Content
                     <a href="{{ route('admin.news.blog.create') }}" class="btn btn-info"><i class="icon-stack-plus mr-2"></i>Creat</a>
                    </h5>
                    <div class="heading-elements">
                        <ul class="icons-list">
                               ...
                               <tbody id="product_list">
                                @foreach ($news as $element)
                                   ...
                                   <td>{{$loop->index+1}}</td>
                                       ...
                                       <td><img class="img-responsive img-thumbnail" src="{{asset('/storage/news/banner/'.$element->banner)}}" alt="" width="120px"></td>

                            
                                       <td>
                                
                                       <a href="{{ route('admin.news.blog.edit',$element->id) }}" class="btn btn-success">
                                         <i class=" icon-pencil5"></i>Edit
                                       </a>
                                            <a href="#" id="delete_news" data-id="{{$element->id}}" data-url="{{ route('admin.news.blog.delete',$element->id) }}" class="btn btn-danger"><i class="  icon-trash"></i>Delete</a>
                                       </td>
