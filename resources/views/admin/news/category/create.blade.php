...
<div class="panel panel-flat">
    ...
    <div class="panel-body">
        <form role="form" action="{{ route('admin.news.category.store') }}" method="post" enctype="multipart/form-data" id="cat_addForm">
            <div class="row">
            ...
            <div class="text-right">
                <button type="submit" class="btn btn-primary"  id="submit">Create Category<i class="icon-arrow-right14 position-right"></i></button>
