...
@section('content')
     <div class="panel panel-flat">
              ...
              <div class="panel-body">
                 <form role="form" action="{{ route('admin.team-member.store') }}" method="post" enctype="multipart/form-data" id="addForm">
                       <div class="row"> 
                         <div class="col-md-6">
                         ...
                         <div class="row">
                             ...
                             <div class="form-group">
                                <label>Youtube:</label>
                                <input type="text" name="youtube" id="youtube" class="form-control" placeholder="Yutube">
                           ...
                           <div class="row">
                             ...
                             <div class="form-group">
                                <label>Twiter:</label>
                              <input type="text" name="twiter" id="twiter" class="form-control" placeholder="Twiter">
                           ...
                           <div class="row">
                             ...
                             <div class="form-group">
                              ...
                              <input type="text" name="google_plus" id="google_plus" class="form-control" placeholder="Google Plus">
                     ...
                     <div class="row">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label>Details:</label>
                            <textarea rows="5" cols="5" class="form-control summernote" name="details" id="details" style="resize: none;"></textarea>
                        </div>
                        </div>
                    ...
                    <button type="submit" class="btn btn-primary"  id="submit">Create Member<i class="icon-arrow-right14 position-right"></i></button>
