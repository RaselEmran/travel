...
@section('procontent')
	...
	<div class="col-md-8 booking-order-details">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <span class="vertical-box"></span><span style="font-size: 24px!important; font-weight: bold; ">Wishlist</span>
                ...
                <div class="row">
                @foreach ($wishlist as $allwish)
                   <div class="col-lg-4 col-md-6 borderimg1">
                          <a href="{{ route('experience-booking',$allwish->packege->id) }}">
					<img src="{{asset('/storage/packege/photo/'.$allwish->packege->photo)}}"
					 class="img1" width="235px" height="175" />

					<div class="centered titleimg1 darkbg1">
					{{$allwish->packege->destination->name}}</div>
				</a>
